...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function openModal(card) {
    ...
    /* Bouton PDF */
    var pdfSection = document.getElementById('modal-pdf-section');
    var pdfBtn     = document.getElementById('modal-pdf-btn');
    if (pdfSection && pdfBtn) {
      var pdfFile = card.dataset.pdf || '';
      if (pdfFile) { pdfBtn.setAttribute('href', pdfFile); pdfSection.style.display = 'flex'; }
